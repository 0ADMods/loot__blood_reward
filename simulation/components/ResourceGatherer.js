...
ResourceGatherer.prototype.Schema =
	...
	"<element name='Rates' a:help='Per-resource-type gather rate multipliers. If a resource type is not specified then it cannot be gathered by this unit'>" +
		"<interleave>" +
			...
			"<optional><element name='blood' a:help='blood gather rate'><ref name='positiveDecimal'/></element></optional>" +
			...
			"<optional><element name='blood.meat' a:help='blood gather rate (overrides \"blood\")'><ref name='positiveDecimal'/></element></optional>" +
			...
			"<optional><element name='treasure.blood' a:help='blood treasure gather rate (overrides \"treasure\")'><ref name='positiveDecimal'/></element></optional>" +
		"</interleave>" +
	"</element>" +
	"<element name='Capacities' a:help='Per-resource-type maximum carrying capacity'>" +
		"<interleave>" +
			...
			"<element name='blood' a:help='blood capacity'><ref name='positiveDecimal'/></element>" +
		"</interleave>" +
	"</element>";
